...
const Dot = styled.button`
  ...
  height: 12px;
  border-radius: 50%;
  background: ${props => (props.active ? '#8b0000' : '#ffcccc')};
  margin: 0 10px;
  border: none;
  cursor: pointer;
  ...
  &:hover {
    transform: scale(1.2);
    background: ${props => (props.active ? '#8b0000' : '#ff9999')};
  }
`;
          ...
          {carouselData.map((slide, index) => {
            ...
            return (
              ...
              >
                ...
                <ProductButton to={`/singleproduct/${slide.id}`}>Product Detail</ProductButton>
              </SlideContainer>
            );
          })}
        </>
